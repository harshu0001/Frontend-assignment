...
export default function ChapterCard({ chapter, index = 3 }: { chapter: Chapter; index?: number }) {
  ...
  >
    ...
    <div className="flex items-center gap-3">
      <Icon className="text-muted-foreground" size={24} weight="duotone" color="#4cb030"/>

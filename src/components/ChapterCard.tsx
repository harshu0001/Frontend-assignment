...
export default function ChapterCard({ chapter, index = 0 }: { chapter: Chapter; index?: number }) {
  ...
  >
    ...
    <div className="flex items-center gap-3">
      <Icon className="text-muted-foreground" size={24} weight="duotone" color="#f2991c"/>
